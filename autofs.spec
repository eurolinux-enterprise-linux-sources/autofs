...
Patch740: autofs-5.1.2-wait-for-master-map-available-at-start.patch
Patch741: autofs-5.1.2-add-master-read-wait-option.patch
Patch742: autofs-5.1.2-update-and-add-README-for-old-autofs-schema.patch
Patch743: autofs-5.1.2-work-around-sss-startup-delay.patch
Patch744: autofs-5.1.2-add-sss-master-map-wait-config-option.patch
Patch755: autofs-5.1.2-fix-included-master-map-not-found-return.patch
Patch756: autofs-5.1.2-dont-fail-on-master-map-read-fail-timeout.patch
Patch757: autofs-5.1.2-set-sane-default-master-read-wait-timeout.patch
Patch758: autofs-5.1.2-dont-return-until-after-master-map-retry-read.patch
Patch759: autofs-5.1.2-make-lookup_nss_read_master-return-nss-status.patch
Patch760: autofs-5.0.7-fix-inconsistent-signed-usage-for-__rpc_ping.patch
...
* Fri Jan 10 2017 Ian Kent <ikent@redhat.com> - 5.0.5-131
- bz1396403 - Trying to access a non-existent directory using automount
              results in 4 minute hang with nfs-utils-1.2.3-73.el6
  - fix inconsistent signed usage for __rpc_ping().
  - check NFS server availability on local mount fallback
- Resolves: rhbz#1396403

* Wed Nov 30 2016 Ian Kent <ikent@redhat.com> - 5.0.5-130
- bz703846 - Incorrect autofs.schema
  - fix autofs.schema.new not copied to package.
- Resolves: rhbz#703846

* Mon Nov 28 2016 Ian Kent <ikent@redhat.com> - 5.0.5-129
- bz1350786 - On every system boot automount needs a restart to access
  NIS map
  - make lookup_nss_read_master() return nss status.
- Related: rhbz#1350786

* Mon Nov 28 2016 Ian Kent <ikent@redhat.com> - 5.0.5-128
- bz1350786 - On every system boot automount needs a restart to access
  NIS map
  - don't return until after master map retry read.
- Related: rhbz#1350786

* Thu Nov 17 2016 Ian Kent <ikent@redhat.com> - 5.0.5-127
- bz1350786 - On every system boot automount needs a restart to access
  NIS map
...
* Mon Oct 17 2016 Ian Kent <ikent@redhat.com> - 5.0.5-126
- bz1384404 - Automounter does not fetch maps from AD
  - work around sss startup delay.
  - add sss master map wait config option.
- Resolves: rhbz#1384404

* Wed Oct 12 2016 Ian Kent <ikent@redhat.com> - 5.0.5-125
- bz703846 - Incorrect autofs.schema
  - update and add README for old autofs schema
- Resolves: rhbz#703846

* Mon Oct 10 2016 Ian Kent <ikent@redhat.com> - 5.0.5-124
- bz1350786 - On every system boot automount needs a restart to access
  NIS map
  - wait for master map available at start.
  - add master read wait option.
- Resolves: rhbz#1350786

* Thu May 5 2016 Ian Kent <ikent@redhat.com> - 5.0.5-123
- bz1277033 - RHEL6.7: shutdown / reboot hangs with findmnt in a readlink
  system call, doing path_walk and stuck in autofs4_wait
